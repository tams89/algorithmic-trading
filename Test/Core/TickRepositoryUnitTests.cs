...
namespace Test.UnitTest.Core
{
    ...
    public class TickRepositoryUnitTests
    {
        ...
        private readonly Tick testTick = new Tick(id, "IBM", DateTime.Today.Date, TimeSpan.Parse("13:59:00.0000000"), 190.00M, 194.44M, 194.39M, 194.4M, 2650);
        ...
        public void GetTick_FromRepository()
        {
            ...
            tickRepository.Setup(a => a.Get(id)).Returns(testTick);

            Assert.AreEqual(tickRepository.Object.Get(id), testTick);
            tickRepository.Verify(x => x.Get(id), Times.Once);
        }
        ...
        public void GetTick_NullData()
        {
            ...
            var tickRepository = new Mock<IReadOnlyRespository<Tick>>();
            tickRepository.Setup(a => a.Get(id));

            Tick testData = null;
            Assert.AreEqual(tickRepository.Object.Get(id), testData);
            tickRepository.Verify(x => x.Get(id), Times.Once);
        }
